-- Sample data for SQLite development and testing
...
-- Regular Users
('user-regular-001', 'user1', 'user1@flightsearch.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDi', 'John', 'Doe', 'ADMIN', NULL, 1),
('user-regular-002', 'user2', 'user2@flightsearch.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDi', 'Jane', 'Smith', 'ADMIN', NULL, 1),
('user-regular-003', 'user3', 'user3@flightsearch.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDi', 'Bob', 'Johnson', 'ADMIN', NULL, 1);
